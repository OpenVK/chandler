...
class CssNode extends \Latte\Compiler\Nodes\StatementNode
{
    public $file;
        ...
        return $context->format(
            <<<'XX'
                ...
                if (file_exists($__realpath)) {
                    ...
                    echo "<link rel=\"stylesheet\" href=\"/assets/packages/static/$__domain/$__file?mod=$__mod\" integrity=\"$__hash\" crossorigin=\"anonymous\">";
                } else {
